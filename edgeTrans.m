...
function [cb2Data,finalMask]= edgeTrans(image);
cb2Data= struct();
close all
...
test3= imclearborder(test3);%Clears border objects
imagesc(test3); pause(0.1)
...
stats= regionprops(mask,image,'Area','Orientation','Perimeter','MajorAxisLength','MinorAxisLength','Centroid','Eccentricity','MaxIntensity','MeanIntensity','MinIntensity','WeightedCentroid','PixelValues','BoundingBox');
cb2Data.stats= stats;
